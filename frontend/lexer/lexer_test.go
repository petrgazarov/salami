...
func getExpectedTokens() []*types.Token {
	return []*types.Token{
		{Type: types.ConstructorName, Value: "@resource", Line: 1, Column: 1},
		{Type: types.ConstructorArg, Value: "aws.cloudwatch.LogGroup", Line: 1, Column: 11},
		{Type: types.ConstructorArg, Value: "ServerLogGroup", Line: 1, Column: 36},
		...
		{Type: types.ConstructorName, Value: "@resource", Line: 4, Column: 1},
		{Type: types.ConstructorArg, Value: "aws.ecr.Repository", Line: 4, Column: 11},
		{Type: types.ConstructorArg, Value: "ServerRepository", Line: 4, Column: 31},
		...
		{Type: types.ConstructorName, Value: "@resource", Line: 8, Column: 1},
		{Type: types.ConstructorArg, Value: "aws.ecr.LifecyclePolicy", Line: 8, Column: 11},
		{Type: types.ConstructorArg, Value: "ServerRepoLifecyclePolicy", Line: 8, Column: 36},
		...
		{Type: types.ConstructorName, Value: "@resource", Line: 12, Column: 1},
		{Type: types.ConstructorArg, Value: "aws.ecs.Service", Line: 12, Column: 11},
		{Type: types.ConstructorArg, Value: "ServerEcsService", Line: 12, Column: 28},
		...
		{Type: types.ConstructorName, Value: "@variable", Line: 31, Column: 1},
		{Type: types.ConstructorArg, Value: "server_container_name", Line: 31, Column: 11},
		{Type: types.ConstructorArg, Value: "string", Line: 31, Column: 34},
		{Type: types.ConstructorArg, Value: "server-container", Line: 31, Column: 42},
