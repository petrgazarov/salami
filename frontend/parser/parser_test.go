...
func getInput() []*frontendTypes.Token {
	return []*frontendTypes.Token{
		{Type: frontendTypes.ConstructorName, Value: "@resource", Line: 1, Column: 1},
		{Type: frontendTypes.ConstructorArg, Value: "aws.cloudwatch.LogGroup", Line: 1, Column: 11},
		{Type: frontendTypes.ConstructorArg, Value: "ServerLogGroup", Line: 1, Column: 36},
		...
		{Type: frontendTypes.ConstructorName, Value: "@resource", Line: 4, Column: 1},
		{Type: frontendTypes.ConstructorArg, Value: "aws.ecr.Repository", Line: 4, Column: 11},
		{Type: frontendTypes.ConstructorArg, Value: "ServerRepository", Line: 4, Column: 31},
		...
		{Type: frontendTypes.ConstructorName, Value: "@resource", Line: 8, Column: 1},
		{Type: frontendTypes.ConstructorArg, Value: "aws.ecr.LifecyclePolicy", Line: 8, Column: 11},
		{Type: frontendTypes.ConstructorArg, Value: "ServerRepoLifecyclePolicy", Line: 8, Column: 36},
		...
		{Type: frontendTypes.ConstructorName, Value: "@resource", Line: 12, Column: 1},
		{Type: frontendTypes.ConstructorArg, Value: "aws.ecs.Service", Line: 12, Column: 11},
		{Type: frontendTypes.ConstructorArg, Value: "ServerEcsService", Line: 12, Column: 28},
		...
		{Type: frontendTypes.ConstructorName, Value: "@variable", Line: 31, Column: 1},
		{Type: frontendTypes.ConstructorArg, Value: "server_container_name", Line: 31, Column: 11},
		{Type: frontendTypes.ConstructorArg, Value: "string", Line: 31, Column: 34},
		{Type: frontendTypes.ConstructorArg, Value: "server-container", Line: 31, Column: 42},
